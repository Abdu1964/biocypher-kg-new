        ...
        if v["represented_as"] == "edge":
            ...
            if source_type is not None and target_type is not None:
                ...
                edge_node_types[label.lower()] = {
                    "source": [item.lower() for item in source_type] if isinstance(source_type, list) else source_type.lower(),
                    "target": [item.lower() for item in target_type] if isinstance(target_type, list) else target_type.lower(),
